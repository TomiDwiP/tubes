          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav" style="margin-right: 15px;">
                <li class="user-name"><span>{{ Auth::user()->nama }}</span></li>
                ...
                <li ><style type="text/css" margin-right="10px"></style></li>
              </ul>
            </div>
          </div>
        </nav>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-check-square-o"></span> PKN <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <h3 class="animated fadeInLeft">Praktek Kerja Nyata</h3>
